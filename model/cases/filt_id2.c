/* filt_id2.c -- filter identification captures, zero initial state.  Per slot: settle (key-on at FLV 0x1E00 Q 0 --
...
static const uint16_t Fv[] = {0x1800, 0x1A00, 0x1B55, 0x1C00, 0x1D00, 0x1DAB, 0x1E00, 0x1E01, 0x1F00, 0x1F80};
static const int Qv[] = {0, 4, 8, 16, 24, 31};

int test_main(void) {
    out_open("filt_id2.txt");
