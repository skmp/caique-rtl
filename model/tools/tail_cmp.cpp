// tail_cmp.cpp -- (promoted from work/tail/tail_cmp.cpp, session 5) replay one tests/slot_tail run (cases/slot_tail.c) through the production AicaModel with the
