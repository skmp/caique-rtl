/* sgc_aeg.c -- amplitude envelope: 4 slots (MIXS 0..3) play a looped constant 0x7FFF, TL 0, filter off, KRS 15, pitch
 ...
 * Runs (4 slots each): attack AR groups; D1R/DL/D2R; RR.
 * Output: sgc_aeg.txt, <run>.hdr/.bin captures, <run>_eg.txt monitor samples */
#include "cap.h"
...
int test_main(void) {
    ...
    static const run_t runs[] = {
        ...
        {"att_22_16", {22, 20, 18, 16}, {0}, {0}, {0}, {31, 31, 31, 31}, 2000, 50},
        {"att_14_08", {14, 12, 10, 8}, {0}, {0}, {0}, {31, 31, 31, 31}, 6000, 50},
        {"att_06_01", {6, 4, 2, 1}, {0}, {0}, {0}, {31, 31, 31, 31}, 11000, 50},
        /* decay 1 to DL, then decay 2; release on key-off */
        {"dec_a", {31, 31, 31, 31}, {31, 28, 24, 20}, {8, 8, 8, 8}, {0, 0, 0, 0}, {31, 31, 31, 31}, 1500, 50},
        {"dec_b", {31, 31, 31, 31}, {16, 12, 8, 4}, {4, 4, 4, 4}, {0, 0, 0, 0}, {31, 31, 31, 31}, 6000, 50},
        {"dec_dl", {31, 31, 31, 31}, {24, 24, 24, 24}, {1, 15, 30, 31}, {0, 0, 0, 0}, {31, 31, 31, 31}, 2500, 50},
        {"dec2", {31, 31, 31, 31}, {31, 31, 31, 31}, {2, 2, 2, 2}, {28, 24, 20, 16}, {31, 31, 31, 31}, 3000, 50},
        {"rel_a", {31, 31, 31, 31}, {0}, {0}, {0}, {31, 28, 24, 20}, 100, 1500},
        {"rel_b", {31, 31, 31, 31}, {0}, {0}, {0}, {16, 12, 8, 4}, 100, 8000},
    };
