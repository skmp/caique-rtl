...
static const int lengths[]={16,128,1024,8192,30000};
static const uint16_t fv[3]={0x1ffe,0x1ffc,0x1ff8};
...
int test_main(void){
 out_open("filt_overflow.txt");ram_fill(0x40000,0,4096);
 for(unsigned b=0;b<sizeof lengths/sizeof lengths[0];b++){
  ...
  for(int i=0;i<lengths[b];i++)sig[512+i]=(i&1)?-32767:32767;
